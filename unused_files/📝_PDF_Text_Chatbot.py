...
def get_conversational_chain():
    prompt_template = """
    Answer the question in a detailed and expressive manner, providing as much relevant information from the provided context as possible. Make sure to use the same text font for every response.
...
with st.sidebar:
    ...
    st.session_state.chat_title = f'PDF-Text-{datetime.datetime.now().strftime("%Y-%m-%d %H:%M")}'
